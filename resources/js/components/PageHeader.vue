        ...
        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
            <nav class="navbar d-flex px-0 py-1">
                ...
                <div v-cloak class="dropdown ml-3">
                    <a id="navbarDropdown" href="#" class="nav-link px-0 text-secondary" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img :src="settings.user.avatar || settings.user.default_avatar" :alt="settings.user.name"
                            class="rounded-circle my-0 shadow-inner" style="width: 33px" />
                    </a>
