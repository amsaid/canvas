<template>
    <section>
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <input v-model="topic.name" type="text" name="name" autofocus autocomplete="off"
                                    title="Name" class="form-control border-0" :placeholder="trans.give_your_topic_a_name"
                            ...
                            <div class="form-group row">
                                ...
                                <input v-model="topic.slug" type="text" name="slug" disabled autocomplete="off" title="Slug"
                                    class="form-control border-0" :class="invalidSlug.shouldShow ? 'is-invalid' : ''"
                            ...
                            <div class="form-group row mt-4 mb-2">
                                <div class="col-md px-0">
                                    <a href="#" onclick="this.blur()"
                                        ...
                                        :class="shouldDisableButton ? 'disabled' : ''" aria-label="Save"
        ...
        <delete-modal ref="deleteModal" :header="trans.delete" :message="trans.deleted_topics_are_gone_forever"
            @delete="deleteTopic" />
    </section>
</template>
