                                ...
                                <div class="align-middle">
                                    <div class="form-group my-auto">
                                        <span class="switch switch-sm">
                                            <input v-model="digest" id="digest" type="checkbox" class="switch"
                                                :checked="settings.user.digest" @change="toggleDigest" />
                        ...
                        <div class="d-flex border-top p-3 align-items-center">
                            ...
                            <div class="ml-auto pl-3">
                                <div class="align-middle">
                                    <div class="form-group my-auto">
                                        <span class="switch switch-sm">
                                            <input v-model="darkMode" id="darkMode" type="checkbox" class="switch"
                                                :checked="settings.user.dark_mode" @change="toggleDarkMode" />
                            ...
                            <div class="ml-auto pl-3">
                                <div class="align-middle">
                                    <div class="form-group row mt-3">
                                        <div class="col-12">
                                            <select v-model="locale" class="custom-select border-0" name="locale"
                                                @change="selectLocale">
                                                <option :key="code" v-for="code in settings.languageCodes" :value="code"
    ...
    computed: {
        ...
        latestRelease() {
            return {
                ...
                link: `https://github.com/amsaid/canvas/releases/tag/${this.settings.version}`,
            };
        },
    },
