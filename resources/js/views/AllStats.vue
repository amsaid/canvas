        ...
        <main class="py-4">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
                <div class="d-flex justify-content-between mt-2 mb-4 align-items-center">
                    ...
                    <select v-model="scope" id="scope" v-if="isReady && isAdmin && hasPublishedPosts" name="scope"
                        class="ml-auto w-auto custom-select border-0 bg-light" @change="changeScope">
                                    ...
                                    <div v-hover="{ class: `hover-bg` }" class="d-flex p-3 align-items-center" :class="{
                                        ...
                                        <div class="ml-auto">
                                            <div class="d-none d-md-inline">
                                                <span class="text-muted mr-3">{{ suffixedNumber(post.views_count) }} {{
                                                    trans.views }}</span>
