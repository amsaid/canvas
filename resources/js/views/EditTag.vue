<template>
    <section>
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="form-group row">
                                ...
                                <input v-model="tag.name" type="text" name="name" autofocus autocomplete="off" title="Name"
                                    class="form-control border-0" :placeholder="trans.give_your_tag_a_name"
                                    @keyup.enter="saveTag" />
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input v-model="tag.slug" type="text" name="slug" disabled autocomplete="off" title="Slug"
        ...
        <delete-modal ref="deleteModal" :header="trans.delete" :message="trans.deleted_tags_are_gone_forever"
            @delete="deleteTag" />
    </section>
</template>
