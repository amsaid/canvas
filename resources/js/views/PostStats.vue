            ...
            <template slot="options" v-if="isReady && canEditPost">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <router-link :to="{ name: 'edit-post', params: { id: $route.params.id } }" class="dropdown-item">
                            {{ trans.edit_post }}
                        </router-link>
                    </div>
                </div>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex">
                                <div class="mr-5">
                                    <p class="mb-0 small text-muted text-uppercase font-weight-bold">
                                        <a v-tooltip="{ placement: 'top' }" href="#" class="text-decoration-none"
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <div v-if="Object.keys(data.topReferers).length > 0">
                            <div :key="`${host}-${views}`" v-for="(views, host, index) in data.topReferers">
                                <div class="d-flex py-2 align-items-center px-2"
                                    :class="index % 2 === 0 ? 'bg-list-muted' : ''">
                                    <div class="mr-auto">
                                        <div v-if="host === trans.other">
                                            <p class="mb-0 py-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                    fill="currentColor" class="mr-1 bi bi-globe" viewBox="0 0 16 16">
                                                    <path
                                                ...
                                                <a v-tooltip="{
                                                    placement: 'right',
                                                }" href="#" class="text-decoration-none text-primary"
                                        ...
                                        <div v-else>
                                            <p class="mb-0 py-1">
                                                ...
                                                <a :href="'https://' + host" class="text-decoration-none text-primary"
                                                    target="_blank">
                                                    {{ host }}
                                                </a>
                                            </p>
                                    ...
                                    <div class="ml-auto">
                                        <span class="text-muted">{{ suffixedNumber(data.monthlyViews) }} {{ trans.views
                                        }}</span>
                                    </div>
                                </div>
                            </div>
