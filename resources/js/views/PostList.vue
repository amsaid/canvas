    ...
    <section>
        <page-header>
            <template slot="options">
                <div class="dropdown">
                    <a id="navbarDropdown" class="nav-link pr-1" href="#" role="button" data-toggle="dropdown"
        ...
        <main v-if="isReady" class="py-4">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
                <div class="d-flex justify-content-between mt-2 mb-4 align-items-end">
                    ...
                    <select v-model="type" id="" name="" class="ml-auto w-auto custom-select border-0" @change="changeType">
                            ...
                            <router-link :to="{
                                ...
                                <div v-hover="{ class: `hover-bg` }" class="d-flex p-3 align-items-center" :class="{
                                    ...
                                    <div class="ml-auto d-none d-md-inline pl-3">
                                        <div id="featuredImage" v-if="post.featured_image" class="mr-2 ml-3 shadow-inner"
                                            :style="{
                                                backgroundImage: 'url(' + post.featured_image + ')',
                                            }" />
                                        <div v-else class="mx-3 align-middle">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="45" viewBox="0 0 24 24"
                                                class="icon-camera">
